...
#    Updated: 2024/04/30 21:24:38 by ahamdi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #


src = mandatory/fdf.c  mandatory/red_map.c  get_next_line/get_next_line_utils.c get_next_line/get_next_line.c mandatory/drawin_3D.c   mandatory/control_keybord.c  mandatory/graden_colore.c 
